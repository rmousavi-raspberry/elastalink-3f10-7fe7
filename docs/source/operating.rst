[elastalink-3f10-7fe7] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [elastalink-3f10-7fe7] container is NOT running**.

.. tip::
   You must have your [elastalink-3f10-7fe7] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/rmousavi-raspberry/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40411  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='rmousavi-raspberry'  \-\-env DOCKERUSERNAME='rmousavi'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/iot-failure-elastalink.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[elastalink-3f10-7fe7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/rmousavi-raspberry/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/elastalink-3f10-7fe7
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37719, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41987, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38921, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35083, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40033, HPDEHOST=127.0.1.1, HPDEPORT=39107, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38539

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3392-elastalink-3f10-7fe7,solution_preprocessing_dag-elastalink-3f10, python-preprocess-281-elastalink-3f10-7fe7,solution_preprocessing_dag-elastalink-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
