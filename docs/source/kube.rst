Scaling [elastalink-3f10-7fe7] With Kubernetes
===========================
...
Based on your TML solution [elastalink-3f10-7fe7] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`elastalink-3f10-7fe7.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-elastalink-3f10-7fe7.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresselastalink-3f10-7fe7.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f elastalink-3f10-7fe7.yml

elastalink-3f10-7fe7.yml
------------------------

.. important::
   Copy and Paste this YAML file: elastalink-3f10-7fe7.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# elastalink-3f10-7fe7.yml
     ...
     kind: Deployment
     metadata:
       name: elastalink-3f10-7fe7
     spec:
       selector:
         matchLabels:
           app: elastalink-3f10-7fe7
       ...
       template:
         ...
         spec:
           containers:
           - name: elastalink-3f10-7fe7
             image: rmousavi/elastalink-3f10-7fe7-amd64:latest
             volumeMounts:
             - name: dockerpath
   ...
   ---
     ...
     kind: Service
     metadata:
       name: elastalink-3f10-7fe7-visualization-service
       labels:
         app: elastalink-3f10-7fe7-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/elastalink-3f10-7fe7 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-elastalink-3f10-7fe7.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-elastalink-3f10-7fe7.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-elastalink-3f10-7fe7.yml
